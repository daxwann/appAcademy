...
def int_remainder_without_modulo(i_dividend, i_divisor)
  remainder = dec_remainder_of_two_integers(i_dividend, i_divisor) * i_divisor
  return remainder.round
end

int_remainder_without_modulo(8, 3)
